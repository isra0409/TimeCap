    ...
    <div className="container py-5">
      ...
      <section className="text-center mb-5">
        ...
        <p className="lead p-4">
          En TimeCap, somos una familia. Creemos en
          el esfuerzo, la disciplina y, sobre todo, en apoyarnos unos a otros.
          Acá no importa si recién empezás o si ya sos un atleta avanzado,
          siempre vas a encontrar un equipo que te motiva a dar lo mejor. ¡Sumate y viví la experiencia TimeCap!
        </p>
      </section>
